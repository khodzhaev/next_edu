...
urlpatterns = [
    ...
    path('students_edit_password/<int:id>/', views.students_edit_password, name='students_edit_password'),
    path('students_delete/', views.students_delete, name='students_delete'),

    # Lessons
    path('lessons/', views.lessons, name='lessons'),
    path('lessons_add/', views.lessons_add, name='lessons_add'),
    path('lessons_edit/<int:id>/', views.lessons_edit, name='lessons_edit'),
